...
独立した因子の2要因被覆や均等割付でケースを縮める因子被覆系(ペアワイズ、直交表、T-way)は [`blackbox-covering.md`](blackbox-covering.md) を参照。
...
独立した因子の被覆で縮約する技法(ペアワイズ、直交表、T-way)は [`blackbox-covering.md`](blackbox-covering.md) を参照。
