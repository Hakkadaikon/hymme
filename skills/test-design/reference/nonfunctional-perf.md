...
品質保証系の非機能(セキュリティ、a11y、互換、信頼性、可用性、カオス、耐障害性、コントラクト、データ品質)は [`nonfunctional-attributes.md`](nonfunctional-attributes.md) に分けた。
...
品質保証系(セキュリティ、a11y、信頼性、耐障害性、コントラクト、データ品質)の網羅の定義は [`nonfunctional-attributes.md`](nonfunctional-attributes.md) の末尾にある。
