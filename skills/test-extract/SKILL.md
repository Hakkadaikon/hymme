...
- 右側に埋めたテストが **skip / pending でなく現に緑で走っているか**も確認する。台帳上は埋まっていても skip で黙殺されていれば、それは守られていないテストである([`../test-catalog/references/levels-operational.md`](../test-catalog/references/levels-operational.md) の skip 黙殺の罠)。
